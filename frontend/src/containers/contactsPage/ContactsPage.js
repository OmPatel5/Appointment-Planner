  ...
  return (
    <div>
      ...
      <section className='contactTiles' style={{background: 'rgba(0, 0, 0, 0.5)', padding: " 50px 50px 70px", borderRadius: "5px"}}>
        <h2>Contacts</h2>
        <TileList onSubmit={props.onSubmit} isEdit={props.isEdit} setIsEdit={props.setIsEdit} isAppointment={false} removeContact={props.removeContact} isEditContact={props.isEditContact} setIsEditContact={props.setIsEditContact} renderInformation={props.contacts}/>
      </section>
    </div>
  );
};
